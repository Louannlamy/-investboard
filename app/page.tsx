...
{activeTab === 'valuation' && (
  <div>
    ...
    <div style={{ background:'#fff', border:'2px dashed rgba(99,102,241,0.3)', borderRadius:16, padding:32, marginBottom:20, textAlign:'center' }}>
      ...
      <div style={{ fontSize:12, color:'#6b7280', marginBottom:20 }}>⚠️ Uploadez uniquement les pages financières (bilan, P&L, cash flow) — maximum 50 pages. Ne pas uploader le rapport complet.</div>
      <input
        type="file"
        accept=".pdf"
